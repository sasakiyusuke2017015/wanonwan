...
| 🟡 実装中 | [発火しない rules の棚卸し + outputs 直 push ガードの機械化](plans/2026-08-20-2023-rules-inventory-and-push-guard.md) | ハーネス育成の第 2 弾。実測で「参照ゼロ・実態と乖離」が確認された rules 4 本と tdd-workflow skill の他プロジェクト残骸を整理し、`outputs/**` 直 push 例外（現在は prose のみ）を CI + hook で機械化する | [step 1](https://github.com/sasakiyusuke2017015/waoon/pull/131) | [計画レビュー](reviews/2026-08-20-2030-rules-inventory-and-push-guard-review.md) |
