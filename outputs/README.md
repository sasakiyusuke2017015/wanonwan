...
| 🟣 マージ承認待ち | [apps/web に Vitest 導入 + API ヘルパ unit テスト](plans/2026-06-15-1725-web-vitest-helper-tests.md) | api-route-helpers 残課題。apps/web に Vitest を導入し parseBody / withActiveUser / checkRateLimit / withServiceRole / metadata の unit テスト（5 files / 13 tests）。test-only | [PR #27](https://github.com/sasakiyusuke2017015/waoon/pull/27) / レビュー省略（test-only・合意） | 笹木さんマージ承認 |
