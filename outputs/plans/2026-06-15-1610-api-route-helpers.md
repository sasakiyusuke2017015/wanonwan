...
- [x] （後続・別タスク）挙動不変の軽い integration test → [api-hardening-lint-guard](2026-06-17-2210-api-hardening-lint-guard.md) Phase 2（[#34](https://github.com/sasakiyusuke2017015/wanonwan/pull/34) merged）で実施
- [x] （後続・別タスク）新規 route のガード強制: `no-restricted-imports` で認証プリミティブ直 import を禁止 → [api-hardening-lint-guard](2026-06-17-2210-api-hardening-lint-guard.md) Phase 1（[#32](https://github.com/sasakiyusuke2017015/wanonwan/pull/32) merged）で実施
